...
def query_modrinth_database(
    ...
    while len(results) < batch_size:
        ...
        for mod in origin_query_results:
            ...
            if not translated_mod or translated_mod["original"] != mod["description"]:
                results.append(
                    Translation(
